...
export const ERROR_REGISTRY: Record<ErrorCode, ErrorDefinition> = {
  ...
  EVENT_FULL: {
    ...
    userMessage: "定員に達したため、回答を締め切りました。",
  ...
  PAYOUT_REQUEST_NOT_FOUND: {
    ...
    typeUri: `${BASE_URI}/payout-request-not-found`,
    severity: "medium",
    retryable: false,
    category: "payment",
  },
  STRIPE_ACCOUNT_MISMATCH: {
    ...
    httpStatus: 409,
    message: "Stripe account ID mismatch",
    userMessage: "Stripeアカウントが一致しません。",
    typeUri: `${BASE_URI}/stripe-account-mismatch`,
    severity: "high",
    retryable: false,
    category: "payment",
  },
  PAYOUT_ID_MISMATCH: {
    code: "PAYOUT_ID_MISMATCH",
    httpStatus: 409,
    message: "Payout ID mismatch with stored record",
    userMessage: "Payout IDが一致しません。",
    typeUri: `${BASE_URI}/payout-id-mismatch`,
    severity: "high",
    retryable: false,
    category: "payment",
  },
