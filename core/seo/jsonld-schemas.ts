...
export function generateSoftwareApplicationSchema(): WithContext<SoftwareApplication> {
  ...
  return {
    ...
    description:
      "「みんなの集金」は、イベントの出欠確認から集金まで、招待リンクをLINEで共有するだけで完了できる、集金 & 出欠確認アプリです。アプリ不要・登録不要で、参加者はニックネームとメールアドレスだけで10秒で参加表明が可能。オンライン集金も現金集金も一つのリストで一元管理できるハイブリッド集金を実現。小銭の管理、未払い対応、名簿と現金の照合など、幹事の集金業務の負担を劇的に軽減します。飲み会・サークル・同窓会など、あらゆるイベントシーンで活躍。初期費用・月額料金0円、現金集金なら完全無料でご利用いただけます。",
