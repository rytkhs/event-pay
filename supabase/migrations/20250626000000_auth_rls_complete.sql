...
-- 統合対象: auth_rls_fixes + restrict_email_access + email_access_complete_restriction
...
1. 以下の重複ファイルを削除してください:
   - supabase/migrations/20250626000000_auth_rls_fixes.sql
   - supabase/migrations/20250626000001_restrict_email_access.sql
   - supabase/migrations/20250626000002_email_access_complete_restriction.sql
...
3. セキュリティ監査の実施:
   - 各テーブルのRLSポリシーが正常に動作することを確認
   - public_profilesビューが期待通りに動作することを確認
   - get_event_creator_name関数が正常に動作することを確認
