-- ====================================================================
-- 20250930120000 update settlement report logic for full refund handling
--  - Includes refunded payments in sales aggregation
--  - Deducts refunded amounts (full & partial) from sales
--  - Removes Stripe fee deduction from net payout (platform-borne)
-- ====================================================================

BEGIN;

-- Override generate_settlement_report with updated logic
