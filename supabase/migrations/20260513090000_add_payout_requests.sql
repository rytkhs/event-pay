...
CREATE INDEX idx_payout_requests_requested_by_requested_at
  ON public.payout_requests USING btree (requested_by, requested_at DESC);
CREATE INDEX idx_payout_requests_profile_requested_at
  ON public.payout_requests USING btree (payout_profile_id, requested_at DESC);
CREATE INDEX idx_payout_requests_community_requested_at
