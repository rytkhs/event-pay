        ...
        <div className="container mx-auto max-w-5xl px-4 py-8">
          <div className="space-y-12">
            ...
            <div className="grid gap-12">
                ...
                <Card className="border-primary/10 overflow-hidden shadow-sm">
                  <CardHeader className="bg-muted/30 pb-4">
                    ...
                    <CardDescription>
                      ...
                      多くの場合、「
                      <span className="font-semibold text-foreground">会員制組織</span>
                      」カテゴリが該当します。
                    </CardDescription>
                  </CardHeader>
                      ...
                      {tableData.map((row, index) => (
                        <div key={index} className="p-4 space-y-3 bg-card">
                          <div className="flex justify-between items-start gap-2">
                            <div className="font-bold text-sm whitespace-pre-line leading-relaxed">
                              {row.community}
                            </div>
                          </div>
              ...
              {/* 戻るボタン（フッター） */}
              <div className="flex justify-center pt-8 border-t border-border/40 pb-12">
                <Link
                  href="/settings/payments"
