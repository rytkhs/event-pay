...
export const FAQSection: React.FC = () => {
  const faqs = [
    {
      q: "参加者はアカウント登録が必要ですか？",
      a: "不要です。参加者は招待リンクから、名前(ニックネーム)とメールアドレスを入力して回答できます。アプリのインストールや専用アカウントの作成は必要ありません。",
    },
    {
      q: "オンライン払いと現金払いを同じイベントで管理できますか？",
      a: "できます。オンライン支払いを選んだ参加者と、現金払いを選んだ参加者を同じイベント内で管理できます。現金払いの参加者は、主催者が受領済みに変更できます。",
    },
    {
      q: "オンライン集金を使うには何が必要ですか？",
      a: "主催者によるオンライン集金の設定が必要です。Stripeのページで振込先の銀行口座の登録や本人確認を行います。",
      link: { label: "オンライン集金・振込のしくみを見る", href: "/guide/online-collection" },
    },
    {
      q: "集めたお金はどこに入りますか？",
    ...
    {
      q: "振込はいつ行われますか？",
      a: "通常、決済完了後、数日程度で振込可能になります。その後任意のタイミングで銀行口座に振込できます。",
    },
    {
      q: "返金はできますか？",
    ...
    {
      q: "カード情報は保存されますか？",
      a: "カード情報は本サービスでは保持しません。オンライン支払いにはStripeを利用しており、カード情報はStripeが安全に管理します。",
    },
    {
