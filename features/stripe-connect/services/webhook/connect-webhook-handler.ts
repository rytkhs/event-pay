...
import { getStripeConnectPort } from "@core/ports/stripe-connect";
...
export class ConnectWebhookHandler {
  ...
  private constructor(supabase: AppSupabaseClient) {
  ...
  static async create(): Promise<ConnectWebhookHandler> {
    ...
    return new ConnectWebhookHandler(adminClient as AppSupabaseClient);
  }
