...
- 「事業者」: 本サービスを提供・運営する者。
- 「コミュニティ」: 主催者が本サービス上で作成し、イベントを束ね、公開ページおよび特定商取引法に基づく表示ページの表示主体となる運営単位。
- 「公開ページ」: コミュニティごとに発行される、本サービス上の公開URLを有する説明ページをいいます。主催コミュニティの説明、問い合わせ導線、および特定商取引法に基づく表示ページへの導線を含みます。
...
- 主催者は、自己が作成または管理するコミュニティを通じてイベントを運営し、参加者その他の閲覧者に対して、当該コミュニティの公開ページおよび特定商取引法に基づく表示ページを表示できるものとします。
- 事業者は、主催者またはコミュニティに代わって販売主体となるものではなく、公開ページ、問い合わせ導線および表示機能を提供するにとどまります。
...
- 主催者は、事業者がコミュニティ単位で公開ページおよび特定商取引法に基づく表示ページを生成、表示または提供することに同意します。
...
- 本規約または本サービス上で別段の表示がない限り、オンライン決済手数料および振込手数料の金額は税込表示とします。
- オンライン決済手数料、振込手数料その他必要な費用は、決済金額、売上金、振込額その他事業者が定める方法により控除または請求されます。
...
- オンライン決済手数料、出金手数料、その他必要な費用は主催者の負担とします。
- 主催者は、オンライン決済手数料および出金手数料が売上金または出金額から控除される場合があることに同意します。
- 税金（消費税、所得税、事業税等）の申告・納付は主催者の責任で行うものとします。

### 手数料改定に関する経過措置

- 2026年5月17日以降に登録した主催者には、登録日以降に作成されるイベントおよび振込について、改定後の手数料を適用します。
- 2026年5月16日23時59分までに登録済みの主催者については、オンライン決済手数料は、2026年7月1日以降に作成されたイベントに係るオンライン決済から、改定後の手数料を適用します。
- 2026年5月16日23時59分までに登録済みの主催者については、出金手数料は、2026年9月1日以降に行われた出金申請に係る振込から適用します。
- 2026年5月16日23時59分までに登録済みの主催者が、2026年6月30日までに作成したイベントについては、当該イベントに係るオンライン決済手数料は、決済日が2026年7月1日以降であっても従前の料率を適用します。
- 本項における日時は、すべて日本時間を基準とします。

## 9. 返金・キャンセル・チャージバック

- 本サービスはアプリ内に返金機能を提供していません。キャンセル等に伴い参加者への返金が必要な場合、主催者と参加者間で返金や精算を行うものとします。
- 原則として返金・キャンセル可否および条件は主催者の裁量により定まります。参加者がオンライン決済（Stripe）を利用した際に発生したオンライン決済手数料は、イベント開催の有無や返金の有無にかかわらず返還されません。
...
- 事業者は、公開ページまたはコミュニティ向け問い合わせフォームを通じて取得した情報を、問い合わせ対応、不正防止、サービス運営および法令対応のために取り扱うことがあります。
