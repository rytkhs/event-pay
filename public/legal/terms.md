...
- 「オンライン決済手数料」: 事業者が定めるオンライン決済の利用に関する手数料。
...
- Stripe ConnectのDestination chargesモデルを採用します。決済時に主催者のConnectアカウントに売上が計上され、オンライン決済手数料等が控除されます。
...
- オンライン決済手数料は4.9%とし、将来変更されることがあります（変更時は本規約または個別規約等で告知）。

## 8. 料金・手数料・税金

- 主催者は、参加者が支払う最終金額を設定します。決済方法（Stripe/現金）によらず参加者に提示される金額は同一です。
- オンライン決済手数料、その他必要な費用は主催者の負担とします。
...
- 不誠実な不対応、不正の疑い、紛争の長期化等が認められる場合、事業者は最終介入権に基づき、Stripe上の返金指示、オンライン決済手数料のリバース、支払の保留・凍結、アカウント制限等の措置を講じることができます。
