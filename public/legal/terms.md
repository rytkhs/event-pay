...
- オンライン集金手数料は、オンラインで支払われた参加費の4.9%とし、将来変更されることがあります（変更時は本規約または個別規約等で告知）。

## 8. 料金・手数料・税金

- 主催者は、参加者が支払う最終金額を設定します。決済方法（Stripe/現金）によらず参加者に提示される金額は同一です。
- オンライン集金手数料、その他必要な費用は主催者の負担とします。
- 税金（消費税、所得税、事業税等）の申告・納付は主催者の責任で行うものとします。

## 9. 返金・キャンセル・チャージバック

- 本サービスはアプリ内に返金機能を提供していません。キャンセル等に伴い参加者への返金が必要な場合、主催者と参加者間で返金や精算を行うものとします。
- 原則として返金・キャンセル可否および条件は主催者の裁量により定まります。参加者がオンライン決済（Stripe）を利用した際に発生したオンライン集金手数料は、イベント開催の有無や返金の有無にかかわらず返還されません。
