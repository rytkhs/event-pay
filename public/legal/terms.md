...
- 「主催者」: 本サービスを用いてイベントを作成・管理し、参加費の受領主体となる者（Stripe Connectの連結アカウント保有者を含む）。
...
- 「オンライン決済」: Stripe決済のこと。
- 「Connectアカウント」: Stripe Connect（Express）における主催者の連結アカウント。
...
- 主催者はStripeの規約に同意・遵守し、Stripe Connectのオンボーディング（KYC/本人確認）を完了し、Stripe所定の審査・要件を満たさない限り、決済機能や振込は利用できません。
...
- Stripe ConnectのDestination chargesモデルを採用します。決済時に主催者のConnectアカウントに売上が計上され、オンライン集金手数料等が控除されます。
- 事業者はカード情報を保持せず、PCI DSS準拠のStripeに委託します。振込スケジュールはStripeの規約・審査・運用に従います。
...
- 主催者は、振込手数料、返金、チャージバック、支払取消、過払い、誤処理その他本サービスまたはStripe決済に関連して主催者が事業者に対して負担する金額について、事業者がStripe ConnectのAccount Debitsその他Stripe所定の方法により、主催者のConnectアカウント残高から当該金額を引き落とし、事業者のStripeアカウントへ移転することに同意します。
