...
ALTER FUNCTION "public"."rpc_guest_get_latest_payment"("p_attendance_id" "uuid") OWNER TO "app_definer";
...
ALTER FUNCTION "public"."rpc_public_attending_count"("p_event_id" "uuid") OWNER TO "app_definer";
