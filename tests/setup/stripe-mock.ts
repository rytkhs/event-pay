...
export const mockPaymentIntent: Stripe.PaymentIntent = {
  ...
  metadata: {},
  next_action: null,
  on_behalf_of: "acct_1TOADDEEczGHQjDD",
  payment_method: null,
  payment_method_configuration_details: null,
  payment_method_options: {},
  payment_method_types: ["card"],
  ...
  transfer_data: {
    destination: "acct_1TOADDEEczGHQjDD",
  },
  transfer_group: null,
  source: null,
};
...
export const mockConnectAccount: Stripe.Account = {
  ...
  external_accounts: {
    ...
    data: [],
    has_more: false,
    url: "/v1/accounts/acct_1TOADDEEczGHQjDD/external_accounts",
  },
  future_requirements: {
    alternatives: [],
...
export const createMockApplicationFeeCalculator = (options?: {
  ...
  return {
    ...
    import("@core/stripe/fee-config/application-fee-calculator").ApplicationFeeCalculator
  >;
};
