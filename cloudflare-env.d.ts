/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 59c459a995bc7cf7cdaf6c174ed7b25e)
// Runtime types generated with workerd@1.20260217.0 2025-10-11 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./sentry-worker");
  }
  interface DemoEnv {
    ...
    NODE_ENV: string;
    AFTER_LOGIN_REDIRECT_PATH: string;
    ...
    WORKER_SELF_REFERENCE: Fetcher /* event-pay-demo */;
  }
  interface Env {
    NEXTJS_ENV: string;
    NEXT_PUBLIC_SUPABASE_URL: string;
    ...
    WORKER_SELF_REFERENCE:
      | Fetcher /* event-pay-demo */
      | Service<typeof import("./sentry-worker").default>;
