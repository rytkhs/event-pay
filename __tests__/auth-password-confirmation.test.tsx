...
describe("🔒 パスワード確認フォームテスト", () => {
  ...
  describe("バリデーションテスト", () => {
    test("パスワードが空の場合にエラーメッセージが表示されること", async () => {
    ...
    test("パスワードが一致しない場合にエラーメッセージが表示されること", async () => {
      const user = userEvent.setup();
      render(<PasswordConfirmationForm onSubmit={mockOnSubmit} />);
    ...
    test("パスワードが8文字未満の場合にエラーメッセージが表示されること", async () => {
      const user = userEvent.setup();
      render(<PasswordConfirmationForm onSubmit={mockOnSubmit} />);
  ...
  describe("アクセシビリティテスト", () => {
    test("エラーメッセージがrole='alert'を持つこと", async () => {
      const user = userEvent.setup();
      render(<PasswordConfirmationForm onSubmit={mockOnSubmit} />);
  ...
  describe("インタラクションテスト", () => {
    ...
    test("フォーム送信後にエラーが解消されること", async () => {
      const user = userEvent.setup();
      render(<PasswordConfirmationForm onSubmit={mockOnSubmit} />);
