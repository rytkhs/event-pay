...
describe("認証Server Actions", () => {
  ...
  describe("resetPasswordAction - パスワードリセット処理", () => {
    ...
    it("存在しないメールアドレスでのパスワードリセット", async () => {
    ...
    it("無効なメールアドレス形式でのパスワードリセット失敗", async () => {
      const invalidEmail = {
        email: "invalid-email-format",
      };
