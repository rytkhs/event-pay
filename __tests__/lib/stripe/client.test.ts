import { stripe, testStripeConnection, stripeConfig, getWebhookSecrets } from "@/lib/stripe/client";
...
describe("Stripe Client", () => {
  ...
  describe("環境変数の検証", () => {
    ...
    it("WebhookシークレットはgetWebhookSecrets()の先頭で取得できる", () => {
      const secret = getWebhookSecrets()[0];
