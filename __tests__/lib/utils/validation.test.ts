...
describe("validation utilities", () => {
  ...
  describe("validateNumberRange", () => {
    ...
    it("カスタムフィールド名でエラーメッセージが生成されること", () => {
