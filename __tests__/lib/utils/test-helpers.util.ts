...
export const mockEnvVars = {
  ...
  STRIPE_WEBHOOK_SECRET_SECONDARY: "whsec_mock_secondary",
  STRIPE_WEBHOOK_SECRET_TEST: "whsec_test_mock",
  STRIPE_WEBHOOK_SECRET_TEST_SECONDARY: "whsec_test_mock_secondary",
  STRIPE_CONNECT_WEBHOOK_SECRET: "whsec_connect_mock",
  STRIPE_CONNECT_WEBHOOK_SECRET_SECONDARY: "whsec_connect_mock_secondary",
  STRIPE_CONNECT_WEBHOOK_SECRET_TEST: "whsec_connect_test_mock",
  STRIPE_CONNECT_WEBHOOK_SECRET_TEST_SECONDARY: "whsec_connect_test_mock_secondary",
