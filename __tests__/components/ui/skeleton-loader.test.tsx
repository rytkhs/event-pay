...
describe("SkeletonLoader コンポーネント", () => {
  ...
  describe("アニメーション制御", () => {
    it("アニメーションが有効な場合にシマーエフェクトが適用される", () => {
    ...
    it("アニメーションが無効な場合にシマーエフェクトが適用されない", () => {
  ...
  describe("レスポンシブデザイン", () => {
    it("レスポンシブ設定が有効な場合に適切なクラスが適用される", () => {
  ...
  describe("パフォーマンス最適化", () => {
    ...
    it("transform3dによるGPUアクセラレーションが適用される", () => {
      render(<SkeletonLoader />);
  ...
  describe("複数のスケルトンローダー", () => {
    ...
    it("フォームフィールドのスケルトンローダーが正しく表示される", () => {
      render(
        <div>
