...
describe("Pagination Component", () => {
  ...
  describe("基本的なページネーション表示", () => {
    it("現在のページ、総件数、ページサイズに基づいてページネーションが表示される", () => {
      ...
      render(<Pagination currentPage={1} totalCount={25} pageSize={10} onPageChange={() => {}} />);
    ...
    it("ページ番号をクリックしてページ遷移できる", async () => {
      ...
      render(
        <Pagination currentPage={1} totalCount={25} pageSize={10} onPageChange={onPageChange} />
      );
    ...
    it("次のページボタンが適切に無効化される（最後のページ）", () => {
      ...
      render(<Pagination currentPage={3} totalCount={25} pageSize={10} onPageChange={() => {}} />);
    ...
    it("1ページ以下の場合はページネーションを表示しない", () => {
      ...
      render(<Pagination currentPage={1} totalCount={5} pageSize={10} onPageChange={() => {}} />);
    ...
    it("ページ2で正しい状態が表示される", () => {
      ...
      render(<Pagination currentPage={2} totalCount={25} pageSize={10} onPageChange={() => {}} />);
  ...
  describe("エラーハンドリング", () => {
    it("無効なページ番号（0）でも適切に動作する", () => {
      ...
      render(<Pagination currentPage={0} totalCount={25} pageSize={10} onPageChange={() => {}} />);
